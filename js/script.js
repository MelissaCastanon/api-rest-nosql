                ...
                fila.innerHTML = `
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="me-2">
                                <img src="img/editar.png" alt="Editar" width="30" height="30" class="img-fluid btnEditar" data-id="${estudiante.id}">
                            </div>
                            <!-- Contenedor para el icono de eliminar -->
                            <div>
                                <img src="img/eliminar.png" alt="Eliminar" width="30" height="30" class="img-fluid btnEliminar" data-id="${estudiante.id}">
                            </div>
                        </div>
                    </td>
                `;
